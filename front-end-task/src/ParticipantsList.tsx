...
export const ParticipantsList: React.FC = () => {
  ...
  return (
    <main className="bg-[#F7F7F7] xl:w-[800px] w-full xl:px-[68px] px-[32px] xl:pt-[40px] pt-[20px] xl:pb-[80px] pb-[40px] self-center">
      <section className="flex flex-col gap-10">
        ...
        <ul className="w-full">
          {participants.map((participant) => (
            <li key={participant.id} className="flex flex-row items-center justify-between py-2 px-6 h-16 bg-[#EDEDED] even:bg-[#F2F2F2] border-2 border-transparent hover:border-2 hover:border-[#222222] box-border">
